...
const Analytics = () => {
  const handleDownloadReport = () => {
    const report = [
      ...
      "", "=== Monthly Disease Trends ===", "Month, Actual Cases, Predicted",
      ...monthlyTrends.map(m => `${m.month}, ${m.cases ?? 'N/A'}, ${m.prediction}`),
      "", "=== Village Comparison ===", "Village, Cholera, Typhoid, Diarrhea",
      ...villageComparison.map(v => `${v.village}, ${v.cholera}, ${v.typhoid}, ${v.diarrhea}`),
      "", "=== Water Quality Data ===", "Month, pH, Turbidity, Contamination%",
