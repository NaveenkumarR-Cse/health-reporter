        ...
        <div className="glass-card p-6 mb-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <Input placeholder="Enter patient name" className="mt-1" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
            </div>
            <div>
              <Label>Age</Label>
              <Input type="number" placeholder="Age" className="mt-1" value={form.age} onChange={(e) => setForm({ ...form, age: e.target.value })} />
            </div>
            <div>
              <Label>Village</Label>
              <Input placeholder="Village name" className="mt-1" value={form.village} onChange={(e) => setForm({ ...form, village: e.target.value })} />
            </div>
            <div>
              <Label>Disease</Label>
