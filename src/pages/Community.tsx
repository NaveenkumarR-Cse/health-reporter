    ...
    <div>
      ...
      <div className="glass-card-elevated p-8 mb-8 text-center relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="mt-3 text-muted-foreground max-w-md mx-auto">
            {riskLevel === "HIGH" ? "High contamination detected. Avoid drinking untreated water."
              : riskLevel === "MEDIUM" ? "Elevated water contamination detected in some areas. Please boil all drinking water."
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="glass-card p-6">
          ...
          <p className="text-sm text-muted-foreground mb-4">Receive health alerts directly on your phone.</p>
          <div className="space-y-3">
